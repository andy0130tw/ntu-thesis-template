-- Modified by qbane for pandoc v3
...
local function table_finder(el)
    if el.classes:find("table") then
        if #el.content == 1 and
           el.content[1] and
           el.content[1].content and
           #(el.content[1].content) == 1 and
           el.content[1].content[1].tag == "Table" then
            for _, cspec in ipairs(el.content[1].content[1].colspecs) do
                print(cspec[1], cspec[2])
            end
            table_width(el.content[1].content[1], el.attributes)
